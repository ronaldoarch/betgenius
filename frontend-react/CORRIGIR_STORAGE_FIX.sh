...
echo "═══════════════════════════════════════════════════════════════"
echo "🔧 CORRIGINDO STORAGE SYMLINK"
echo "═══════════════════════════════════════════════════════════════"
echo ""

echo "1️⃣ Verificando public/storage:"
echo "───────────────────────────────────────────────────────────────"
if [ -L "public/storage" ]; then
    echo "   ✅ É symlink"
    ls -la public/storage | head -1
elif [ -d "public/storage" ]; then
    echo "   ⚠️  É um diretório real (PROBLEMA!)"
...
echo "2️⃣ Movendo arquivos de public/storage para storage/app/public:"
echo "───────────────────────────────────────────────────────────────"
if [ -d "public/storage" ]; then
    if [ -L "public/storage" ]; then
        echo "   public/storage já é symlink, pulando..."
    else
        echo "   public/storage é diretório real, movendo arquivos..."
        mkdir -p storage/app/public/uploads
        
        if [ -d "public/storage/uploads" ]; then
            echo "   Copiando arquivos de public/storage/uploads..."
    ...
    echo "   public/storage não existe, pulando..."
fi
echo ""

echo "3️⃣ Removendo public/storage e criando symlink:"
echo "───────────────────────────────────────────────────────────────"
if [ -d "public/storage" ]; then
    if [ -L "public/storage" ]; then
        echo "   public/storage já é symlink, removendo para recriar..."
    else
        echo "   Fazendo backup do diretório real..."
...
echo "4️⃣ Buscando paths dos logos na API:"
echo "───────────────────────────────────────────────────────────────"
...
echo "5️⃣ Verificando se os logos existem:"
echo "───────────────────────────────────────────────────────────────"
...
echo "7️⃣ Testando URLs dos logos:"
echo "───────────────────────────────────────────────────────────────"
if [ -n "$LOGO_WHITE" ]; then
